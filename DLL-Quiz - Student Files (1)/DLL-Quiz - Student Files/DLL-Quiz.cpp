...
int main()
{
  ...
  // sketch in comments (the autograder's code review pass ignores comments) For example:
    ...
    ///////////////////////// TO-DO (3) //////////////////////////////
        +------------------------------------+
        |                                    |
        +-> _sentinel <-> {{{00000000000000, 20, 00000000000000}}} <-+
        _head -> {{{00000000000000, 20, 00000000000000}}}
        _tail -> {{{00000000000000, 20, 00000000000000}}}
        _size  =  1
    /////////////////////// END-TO-DO (3) ////////////////////////////
  #endif
  ...
  // sketch in comments (the autograder's code review pass ignores comments) For example:
    ...
    ///////////////////////// TO-DO (4) //////////////////////////////
        +--------------------------------------------------------+
        |                                                        |
        +-> _sentinel <-> {{{00000000000000, 10, 00000000000000}}} <-> {{{00000000000000, 20, 00000000000000}}} <-+
        _head -> {{{00000000000000, 10, 00000000000000}}}
        _tail -> {{{00000000000000, 20, 00000000000000}}}
        _size  =  2
    /////////////////////// END-TO-DO (4) ////////////////////////////
  #endif
  ...
  // sketch in comments (the autograder's code review pass ignores comments) For example:
    ...
    ///////////////////////// TO-DO (5) //////////////////////////////
        +--------------------------------------------------------------------------------+
        |                                                                                |
        +-> _sentinel <-> {{{00000000000000, 10, 00000000000000}}} <-> {{{00000000000000, 20, 00000000000000}}} <-> {{{00000000000000, 40, 00000000000000}}} <-+
        _head -> {{{00000000000000, 10, 00000000000000}}}
        _tail -> {{{00000000000000, 40, 00000000000000}}}
        _size  =  3
    /////////////////////// END-TO-DO (5) ////////////////////////////
  #endif
  ...
  // sketch in comments (the autograder's code review pass ignores comments) For example:
    ...
    ///////////////////////// TO-DO (6) //////////////////////////////
        +--------------------------------------------------------------------------------+
        |                                                                                |
        +-> _sentinel <-> {{{00000000000000, 10, 00000000000000}}} <-> {{{00000000000000, 30, 00000000000000}}} <-> {{{00000000000000, 20, 00000000000000}}} <-> {{{00000000000000, 40, 00000000000000}}} <-+
        _head -> {{{00000000000000, 10, 00000000000000}}}
        _tail -> {{{00000000000000, 40, 00000000000000}}}
        _size  =  4
    /////////////////////// END-TO-DO (6) ////////////////////////////
